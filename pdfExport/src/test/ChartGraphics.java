...
public class ChartGraphics {
    ...
    private int imageHeight = 2250; //图片的高度
    //生成图片文件
...
//        tip.setColor(new Color(255, 120, 89));
        //填充区域并确定区域大小位置
        tip.fillRect(600, tip_2_top, 300, H_tip);
        //设置字体颜色，先设置颜色，再填充内容
        tip.setColor(Color.BLACK);
        //设置字体
        Font tipFont = new Font("宋体", Font.PLAIN, 40);
        tip.setFont(tipFont);
        tip.drawString("登录成功，本次认证时间1小时", 600, tip_2_top+(H_tip)/2-10);
        tip.drawString("正在返回商家主页", 600, tip_2_top+(H_tip)/2+10);
    ...
    public static void main(String[] args) {
        ...
        try {
            cg.graphicsGeneration("ewew", "1", "12", "F:\\test123.jpg");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
